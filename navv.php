    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a><span>Support</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="chat/login.php"><span>technical support</span> </a>
              <li class="dropdown"><a href="service/index.php"><span>Service appointment</span> </a>
            </ul>
          </li>
          ...
          <?php if(!isset($_SESSION["user_id"]))
            {
          ?>
          <li class="dropdown"><a href="about_me.php" class="bi bi-person-plus-fill"></a>
            <ul>
