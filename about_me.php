                ...
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            ...
                            <div class="row about-list">
                                <div class="col-md-6">
                                   <div class="media">
                                    ...
                                    <div class="media">
                                        ...
                                        <p>********</p><a href="update_password.php?user_id=<?php echo $user_id; ?>"><i class="bi bi-pencil-square"></i></a>
                                    </div>
                                    <div class="media">
                                        <label>Phone</label>
                                ...
                                <div class="col-md-6">
                                    <a href="update_aboutme.php?user_id=<?php echo $user_id; ?>"><i class="bi bi-pencil-square"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-avatar">
                            ...
                            <img src="profile_image/<?php echo $row['pro_pic']?>" title="" alt="">
