    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><span>Support</span> <i class="bi bi-chevron-down"></i>
            <ul>
              <li class="dropdown"><a href="chat/login.php"><span>technical support</span> <i class="bi bi-chevron-right"></i></a>
              <li class="dropdown"><a href="service/index.php"><span>Service appointment</span> <i class="bi bi-chevron-right"></i></a>
            </ul>
          </li>
          ...
          <?php if(!isset($_SESSION["user_id"]))
            {
          ?>
          <li class="dropdown"><a href="user/index.php" class="bi bi-person-plus-fill"></a>
            <ul>
              <li class="dropdown"><a href="user/login.php"><span>Sign in</span></a>
              <li class="dropdown"><a href="user/register.php"><span>Sign up</span></a>
            </ul>
          </li>
          <?php 
            }else{
          ...
          <li class="dropdown"><a href="about_me.php" class="bi bi-person-circle"></a>
            <ul>
              ...
              <li class="dropdown"><a href="user/logout.php"><span>logout</span></a>
            </ul>
          </li>
          <?php   
            }
